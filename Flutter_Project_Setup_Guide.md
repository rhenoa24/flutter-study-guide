...
Since you already have a **cloned, empty (or near-empty) GitHub repo**, the cleanest approach is to generate the Flutter project *directly inside* that folder rather than creating it elsewhere and moving files.
